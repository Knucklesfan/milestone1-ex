...
void st_menu(void)
{
  ...
  options_audio   = new Menu();
  options_debug   = new Menu();
  options_video   = new Menu();
  ...
  options_menu->additem(MN_GOTO,"Video",0,options_video,MNID_VIDEOMENU);
  options_menu->additem(MN_GOTO,"Audio",0,options_audio,MNID_AUDIOMENU);
  options_menu->additem(MN_GOTO,"Gameplay",0,options_audio,MNID_GAMEPLAYMENU);
  options_menu->additem(MN_GOTO,"Input",0,options_keys_menu,MNID_VIDEOMENU);
  options_menu->additem(MN_GOTO,"Debug",0,options_debug,MNID_DEBUGMENU);

  options_video->additem(MN_LABEL,"Video Options",0,0);
  options_audio->additem(MN_LABEL,"Audio Options",0,0);
  options_debug->additem(MN_LABEL,"Debug Options",0,0);

#ifndef GP2X
#ifndef NOOPENGL
  options_video->additem(MN_TOGGLE,"OpenGL",use_gl,0, MNID_OPENGL);
#else
  options_video->additem(MN_DEACTIVE,"OpenGL (not supported)",use_gl, 0, MNID_OPENGL);
#endif
  options_video->additem(MN_TOGGLE,"Fullscreen",use_fullscreen,0, MNID_FULLSCREEN);
#endif
#ifndef NOSOUND
  if(audio_device)
    {
      options_audio->additem(MN_TOGGLE,"Sound     ", use_sound,0, MNID_SOUND);
      options_audio->additem(MN_TOGGLE,"Music     ", use_music,0, MNID_MUSIC);
    }
  else
#endif
    {
      options_audio->additem(MN_DEACTIVE,"Sound     ", false,0, MNID_SOUND);
      options_audio->additem(MN_DEACTIVE,"Music     ", false,0, MNID_MUSIC);
    }
#ifdef TSCONTROL
  options_video->additem(MN_TOGGLE,"Show Mouse",show_mouse,0, MNID_SHOWMOUSE);
#endif
  options_debug->additem(MN_TOGGLE,"Show FPS  ",show_fps,0, MNID_SHOWFPS);
  ...
  options_audio->additem(MN_HL,"",0,0);
  options_audio->additem(MN_BACK,"Back",0,0);

  options_video->additem(MN_HL,"",0,0);
  options_video->additem(MN_BACK,"Back",0,0);

  options_debug->additem(MN_HL,"",0,0);
  options_debug->additem(MN_BACK,"Back",0,0);
